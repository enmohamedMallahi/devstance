export default function Navbar() {
  return (
    ...
    <div className="dark:bg-gray-800 dark:text-white py-4 md:py-8 px-4 md:px-8">

      <div className="mb-10 md:mb-16">
        <h2 className="mb-4 text-center text-2xl font-bold text-blue-800 lg:text-3xl">Get in touch</h2>
      ...
      <form action="https://formspree.io/f/mayggrnr" method="POST" className="mx-auto grid max-w-screen-md gap-4">
        <div>
          <label for="full-name" className="mb-2 inline-block text-sm text-gray-800 sm:text-base">Full name*</label>
          <input required name="full-name" className="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
        </div>
        ...
        <div className="">
          ...
          <textarea name="message" className="h-40 w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring"></textarea>
        </div>

        <div className="flex items-center justify-between ">
          <button type="submit" className="w-full inline-block rounded-lg bg-indigo-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base">Send</button>
