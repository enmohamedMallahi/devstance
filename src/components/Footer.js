export default function Footer() {
  return (
    ...
    <footer className="mx-auto max-w-screen-2xl px-4 md:px-8">
      <div className="flex flex-col items-center justify-between gap-4 border-tt border-b py-6 md:flex-row">

        {/* <nav className="w-full flex flex-wrap justify-center items-center text-center gap-x-4 gap-y-2 md:gap-6">
      ...
      <div className="py-8 text-center text-sm text-gray-400">© 2022-2023 - Present DevStance. All rights reserved.</div>
    </footer>
